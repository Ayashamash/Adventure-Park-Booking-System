        ...
        return (
            <div>
                <div className="navbar navbar-expand-lg navbar-dark bg-dark" style={{ position: 'relative' }}>
                    <a className="btn btn-warning" href="/admincontrol" style={{marginRight:'25px'}}>Admin Home</a>
                                        ...
                                        this.state.rides.map(
                                            rides => <tr key={rides.id}>
                                                ...
                                                <td>
                                                    ...
                                                    <button className="btn btn-warning btn-sm" name="id" onClick={() => this.deleteRide(rides.id)} style={{ margin: '5px' }}>Delete</button>
                                                </td>
                                            </tr>
                                        )
                                    }
