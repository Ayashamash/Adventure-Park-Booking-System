        ...
        return (
            <div>
                <div className="row justify-content-center">
                    <div className="card border-primary" style={{ margin: '2%' }}>
                        <h2 className="text-center text-primary">Payment</h2>
                        <h5 className="text-center text-success">Total Amount Payable = {this.state.amount} Rs</h5>

                        <div className="form-group" style={{ width: '50rem', padding: '25px' }}>
                        ...
                        <button className="btn btn-primary" style={{ margin: '7px' }} onClick={this.makePayment}>Pay and Book</button>
