            ...
            <div>
                <div className="row justify-content-center align-items-center" style={{ margin: '15px' }}>
                    <div className="card border-primary">
                        <div style={{ padding: '50px', width: '40rem' }}>
                            <form>
                                ...
                                <div className="form-group">
                                    <label>Email</label>
                                    <input type="text" placeholder="e.g. edac@gmail.com" name="email"
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" placeholder="current address" name="city"
                                ...
                                <button className="btn btn-primary btn-block" onClick={this.saveUser}>Register</button>
