                        ...
                        <div className="card border-primary" style={{ padding: '20px', width: '50rem' }}>
                            <div>
                                <form>
                                    ...
                                    <button className="btn btn-primary btn-block" onClick={this.saveForm}>Save and make Payment</button>
                                    <button className="btn btn-danger btn-block" style={{ margintop: '10px' }} >Cancel Rides</button>
